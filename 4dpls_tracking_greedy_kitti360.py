# Usage: python 4dpls_tracking_greedy_kitti360.py -t 1 -p test/val_preds_TS1_kitti360 -sd results/validation/Kitti360/TS1 -dc data/Kitti360/kitti-360.yaml

# python 4dpls_tracking_greedy_kitti360.py -t 1 -p ../../achakrav/4D-PLS/test/val_preds_TS1_kitti360 -sd tracking/Kitti360/TS1 -dc data/SemanticKitti/semantic-kitti.yaml
...
def parse_poses(filename, calibration, seq_frames):
...
def main(FLAGS):
    ...
    calib = np.eye(4)
    calib_file = os.path.join(dataset, 'calibration', 'calib_cam_to_velo.txt')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser("./4dpls_tracking_greedy_kitti360.py")
