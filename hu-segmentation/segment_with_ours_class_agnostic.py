...
if __name__ == '__main__':
    ...
    if args.dataset == 'semantic-kitti':
        ...
        objsem_folder = '/project_data/ramanan/achakrav/4D-PLS/results/validation/4DPLS_original_params_original_repo_nframes1_1e-3_importance_None_str1_bigpug_1/val_probs/'.format(args.task_set)
