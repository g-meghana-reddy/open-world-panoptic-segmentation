...
def test_ipbcar_depth_normal():
  ...
  for scan_idx in range(10):
    ...
    current_range, current_vertex = range_projection_vertex(current_vertex, fov_up=16.6, fov_down=-16.6)
    ...
    print('Time for generating normal map: ', time.time() - time_normal_map)
    ...
    ax.imshow(current_range, aspect='equal', cmap=plt.get_cmap('gray'), vmin=0, vmax=255)
